                    ...
                    if cur_test and not cur_test.get("completed") and cur_test.get("status") in ("running", "ready", "running_left", "running_right"):
                        ...
                        if tidx == 0:  # 平衡：有效用时（扣除暂停时间）
                            ...
                            if vals:
                                ...
                                cur_test["score"] = round(self.engine._score_knee_flexibility(avg_k).score, 1)
                            else:
                                cur_test["score"] = 0
                        elif tidx == 2:  # 肩
    ...
    def _eval_squat(self, state, angles, kps):
        ...
        if knee < 120:
            ...
            if knee < 90:
                ...
                t["score"] = round(self.engine._score_knee_flexibility(avg).score,1)
    ...
    def _eval_squat_video(self, state, angles, kps):
        ...
        if knee < 120:
            ...
            if knee < 90:
                ...
                test["score"] = round(self.engine._score_knee_flexibility(avg).score, 1)
