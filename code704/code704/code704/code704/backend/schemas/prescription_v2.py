...
class GenerateRequest(BaseModel):
    ...
    training_goal: Optional[str] = Field(default='comprehensive', description="训练目标：comprehensive/posture/strength/flexibility/fatloss")
    training_duration: Optional[int] = Field(default=15, description="单次训练时长（分钟）")
    training_frequency: Optional[int] = Field(default=3, description="每周训练频率（次）")
