...
import PrescriptionTrainingReportPage from "./pages/PrescriptionTrainingReportPage";
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<PrivateRoute><MainLayout /></PrivateRoute>}>
        ...
        <Route path="training/report/:id" element={<TrainingReportPage />} />
        <Route path="prescription-training" element={<PrescriptionTrainingPage />} />
        <Route path="prescription-training/report/:id" element={<PrescriptionTrainingReportPage />} />
