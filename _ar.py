report = r"""import { useEffect, useState } from "react";
...
fpath = r"D:\workbench\program3\code\pose-system\pose-system\frontend\src\pages\AssessmentReportPage.tsx"
with open(fpath, "w", encoding="utf-8") as f:
    f.write(report)
print(f"AssessmentReportPage: {len(report)} chars")